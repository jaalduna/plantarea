...
import { Shield, LayoutDashboard, Store, Flag, ArrowLeft } from "lucide-react";
import { cn } from "@/lib/utils";

const navItems = [
  { to: "/admin", label: "Dashboard", icon: LayoutDashboard },
  { to: "/admin/viveros", label: "Viveros", icon: Store },
  { to: "/admin/moderacion", label: "Moderación", icon: Flag },
];
    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex flex-1 flex-col">
        <header className="flex h-16 items-center gap-4 border-b border-border bg-background px-4 lg:hidden">
          ...
          <span className="text-lg font-bold">Admin Plantarea</span>
        </header>
